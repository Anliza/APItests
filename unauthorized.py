...
headers = {
    ...
    "Cookie": "token=abc123",
    "Authorization": "Basic YWRtaW46cGFzc" #Modify the authorization credentials to test how the API responds to unauthorized access attempts.
}
